...
tab_n_sv=tab_n_sv+1
fname=paste("Table",tab_n_sv,"RRA_mageck",i,"tsv",sep=".")
...
Fields specific to **negative** selection are prefixed with `neg` in the source table `r ctable_fname`.
...
Fields specific to **positive** selection are prefixed with `pos` in the source table `r ctable_fname`.
...
figurecap2=paste("shRNA ranks for comparison ",i,".\nTop genes in positive selection (by pos.rank) are shown (top genes at the bottom of the plot).\n shRNAs are coloured by their fold change direction.", sep="")
  ...
  graphics.off()
  fig_n=fig_n+1
  ggsave(filename=paste("Figure",fig_n,"shRNA_ranks_positive",i,"pdf",sep="."),plot=p2.4,path=plotdir.i,device="pdf")

  graphics.off()
  fig_n=fig_n+1
  ggsave(filename=paste("Figure",fig_n,"shRNA_ranks_negative",i,"pdf",sep="."),plot=p2.3,path=plotdir.i,device="pdf")
